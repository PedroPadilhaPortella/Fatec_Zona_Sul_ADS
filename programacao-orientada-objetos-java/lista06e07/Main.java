...
class Main {
    public static void main(String[] args) {
        try {
            ...
            JOptionPane.showMessageDialog(null, "As notas não podem ser menores que zero");
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Ocorreu um erro inexperado. Verifique seus inputs.");
        }
    }
}
