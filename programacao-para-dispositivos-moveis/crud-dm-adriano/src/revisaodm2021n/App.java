...
public class App {
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
    	...
    	while(true) {
	        ...
	        JOptionPane.showMessageDialog(null,"SISTEMA DE CADASTRO PESSOAS, DEPARTAMENTO, USUARIO E NOTEBOOKS");
	        JOptionPane.showMessageDialog(null,"ENTRE COM: 1 - PESSOAS, 2 - DEPARTAMENTO, 3 - USUARIO, 4 - NOTEBOOKS 5 - SAIR");
