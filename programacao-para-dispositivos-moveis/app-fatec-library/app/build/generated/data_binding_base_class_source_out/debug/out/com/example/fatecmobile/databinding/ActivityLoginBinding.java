...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull Button btentrar,
      @NonNull Button btnovousu, @NonNull ConstraintLayout linearLayout, @NonNull EditText login,
      @NonNull EditText senha, @NonNull TextView textView2, @NonNull TextView textView3) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, btentrar, btnovousu,
          linearLayout, login, senha, textView2, textView3);
    }
